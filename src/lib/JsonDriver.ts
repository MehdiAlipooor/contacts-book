...
import { NoRecordExists, WrongFormatException } from "@/lib/Exceptions";
import type { BaseEntity, ID } from "@/types";

export interface JsonDriverContracts<T extends BaseEntity> {
...
export class JsonDriver<T extends BaseEntity>
	implements JsonDriverContracts<T>
{
	...
	private async read(): Promise<T[]> {
		try {
			...
			if (!Array.isArray(parsed)) {
				throw new WrongFormatException("Storage should be array");
			}
